...
class ProductsSpider(scrapy.Spider):
    ...
    custom_settings = {
        'RETRY_ENABLED': True,  
        'RETRY_TIMES': 3,
        'DOWNLOAD_DELAY': 0.40,                    # 25 milisecond delay between requests
        'CONCURRENT_REQUESTS': 13,                  # max number of concurrent requests on all domains
        ...
        'AUTOTHROTTLE_START_DELAY': 0.40,             # initial delay
        'AUTOTHROTTLE_MAX_DELAY': 0.65,                # max delay
